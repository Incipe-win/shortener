...
var (
	...
	cacheSqlTestShortUrlMapIdPrefix   = "cache:sqlTest:shortUrlMap:id:"
	cacheSqlTestShortUrlMapMd5Prefix  = "cache:sqlTest:shortUrlMap:md5:"
	cacheSqlTestShortUrlMapSurlPrefix = "cache:sqlTest:shortUrlMap:surl:"
)
...
func (m *defaultShortUrlMapModel) Delete(ctx context.Context, id uint64) error {
	...
	sqlTestShortUrlMapIdKey := fmt.Sprintf("%s%v", cacheSqlTestShortUrlMapIdPrefix, id)
...
func (m *defaultShortUrlMapModel) FindOne(ctx context.Context, id uint64) (*ShortUrlMap, error) {
	...
	err := m.QueryRowCtx(ctx, &resp, sqlTestShortUrlMapIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultShortUrlMapModel) FindOneByMd5(ctx context.Context, md5 sql.NullString) (*ShortUrlMap, error) {
	sqlTestShortUrlMapMd5Key := fmt.Sprintf("%s%v", cacheSqlTestShortUrlMapMd5Prefix, md5)
	var resp ShortUrlMap
	err := m.QueryRowIndexCtx(ctx, &resp, sqlTestShortUrlMapMd5Key, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultShortUrlMapModel) FindOneBySurl(ctx context.Context, surl sql.NullString) (*ShortUrlMap, error) {
	sqlTestShortUrlMapSurlKey := fmt.Sprintf("%s%v", cacheSqlTestShortUrlMapSurlPrefix, surl)
	var resp ShortUrlMap
	err := m.QueryRowIndexCtx(ctx, &resp, sqlTestShortUrlMapSurlKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultShortUrlMapModel) Insert(ctx context.Context, data *ShortUrlMap) (sql.Result, error) {
	sqlTestShortUrlMapIdKey := fmt.Sprintf("%s%v", cacheSqlTestShortUrlMapIdPrefix, data.Id)
	sqlTestShortUrlMapMd5Key := fmt.Sprintf("%s%v", cacheSqlTestShortUrlMapMd5Prefix, data.Md5)
	sqlTestShortUrlMapSurlKey := fmt.Sprintf("%s%v", cacheSqlTestShortUrlMapSurlPrefix, data.Surl)
...
func (m *defaultShortUrlMapModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheSqlTestShortUrlMapIdPrefix, primary)
}
